...
/*   Updated: 2017/05/25 21:58:15 by oklymeno         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	write_value(t_param *params, t_processor *proc, unsigned int r)
{
	...
	adr = proc->prog_counter + (handle_indirect(params, proc, 2) % IDX_MOD);
...
void	handle_st(t_param *params, t_processor *proc)
{
	...
	r1 = params->map[proc->prog_counter + 2] - 1;
	r2 = params->map[proc->prog_counter + 3] - 1;
