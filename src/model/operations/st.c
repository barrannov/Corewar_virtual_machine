...
/*   Updated: 2017/06/07 20:03:26 by oklymeno         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	write_value(t_param *params, t_processor *proc, unsigned int r)
{
	...
	params->map_c[adr] = proc->player - 256;
	params->map_c[adr + 1] = proc->player - 256;
	params->map_c[adr + 2] = proc->player - 256;
	params->map_c[adr + 3] = proc->player - 256;
}
